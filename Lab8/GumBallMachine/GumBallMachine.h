...
namespace with_state
{
	struct IState
	{
		virtual void InsertQuarter() = 0;	// вставить монетку
		virtual void EjectQuarter() = 0;	// вытащить монетку
		virtual void TurnCrank() = 0;		// повернуть рукоять
		virtual void Dispense()	= 0;		// получить жвачку
	...
	{
		virtual void ReleaseBall() = 0; // выкатить жвачку
		virtual unsigned GetBallCount() const = 0; 

		virtual void SetSoldState()	= 0;		// жвачка продается
		virtual void SetSoldOutState() = 0;		// жвачки закончились
		virtual void SetNoQuarterState() = 0;	// нет монетки
		virtual void SetHasQuarterState() = 0;	// имеется монетка

		virtual ~IGumballMachine() = default;
	};

	// состояние выдачи жвачки
	...
	// состояние когда автомат пустой
	...
	// состояние когда вставлена монетка
	...
	// состояние когда монетка не вставлена
